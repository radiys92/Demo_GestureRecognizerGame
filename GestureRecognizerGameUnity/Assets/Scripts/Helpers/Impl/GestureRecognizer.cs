...
namespace Helpers.Impl
{
    public class GestureRecognizer : IGestureRecognizer
    {
        ...
        private List<Vector2> RotateGesture(List<Vector2> pointArray, float radians, Vector3 center)
        {
        ...
        private float GestureMatch(List<Vector2> pointArray, List<Vector2> p2)
        {
        ...
        private float CalcDistanceAtOptimalAngle(List<Vector2> pointArray,
            List<Vector2> template,
            float negativeAngle,
            float positiveAngle)
        {
        ...
        private float CalcDistanceAtAngle(List<Vector2> pointArray, List<Vector2> template, float radians)
        {
